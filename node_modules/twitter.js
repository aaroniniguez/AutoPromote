...
module.exports.verifyLoginInfo = async function verifyLoginInfo(username, password) {
...
module.exports.postOnTwitter = async function (username, password, data, uploadFile = false, randomFollow = false) {
		...
		if(randomFollow) {
			...
			await page.waitForXPath(selector).catch(function(err){
				console.log("Follow twitter user selector not found: " + err);
			});
