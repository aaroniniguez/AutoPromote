...
async function login(page, credentials) {
	...
	let EH = await page.waitForSelector(usernameSelector).catch(elementDoesntExist);
	await EH.type(username, typeDelay);
	await page.type(passwordSelector, password, typeDelay).catch(elementDoesntExist);
