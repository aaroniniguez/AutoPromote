...
class Twitter {
	...
	async login() {
		try {
			...
			const usernameSelector = UISelectorsObject.getUsernameSelector();
			const passwordSelector = UISelectorsObject.getPasswordSelector();
			...
			let loginButton = UISelectorsObject.getLoginButton(); 
